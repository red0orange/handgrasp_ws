...
class BaseDataset(data.Dataset):
    def __init__(self,
        ...
        self.renderer = OnlineObjectRenderer(caching=False)
    ...
    def read_object_grasp_data(self,
        ...
        if os.path.exists(os.path.join(root_folder, json_dict['object'])):
            pass
        # elif os.path.exists(os.path.join(root_folder, json_dict['object'].replace('.stl', '.obj'))):
        #     json_dict['object'] = json_dict['object'].replace('.stl', '.obj')
        else:
        ...
        def cluster_grasps(grasps, qualities):
            ...
            output_qualities = np.asarray(output_qualities, dtype=object)
