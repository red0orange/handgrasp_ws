...
class ConstrainedGraspEvaluatorData(BaseDataset):
    ...
    def read_object_grasp_data(self,
        ...
        mesh_dir = self.opt.mesh_root_folder
        mesh_fname = os.path.basename(json_dict['mesh/file'])
        mesh_path = os.path.join(mesh_dir, mesh_fname)

        # object_model = Object(json_dict['mesh/file'])
        object_model = Object(mesh_path)
