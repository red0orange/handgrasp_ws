...
if __name__ == "__main__":
    ...
    dataset = _AcronymDataset(data_dir=data_dir, phase='test', n_pointcloud=8096, n_density=80, n_coords=400, augmented_rotation=True, center_pcl=True, split=True, partial=False)

    for data in dataset:
        ori_pcl, pcl, H_grasps, _, _ = data
        draw_scene(pcl, H_grasps, z_direction=True, scale=1.0/dataset.scale, max_grasps=10)
