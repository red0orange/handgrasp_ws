...
if __name__ == "__main__":
    ...
    pcd = np.load("/home/red0orange/下载/tmp.npy")
    pcd_colors = pcd[:, 3:6] / 255.0
    pcd = pcd[:, :3]
    ...
    while True:
        xyz = dataset.preprocess_infer_data(pcd)
        ...
        viser_for_grasp.add_pcd(pcd, pcd_colors)
        viser_for_grasp.vis_grasp_scene(vis_T, max_grasp_num=30)
